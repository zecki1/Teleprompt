...
var SignalRService = class _SignalRService {
  constructor(ngZone, authService) {
    this.ngZone = ngZone;
  ...
  startConnection(hubName, hubUrl) {
    return __async(this, null, function* () {
      ...
      const connection = new HubConnectionBuilder().withUrl(hubUrl, {
        ...
        nextRetryDelayInMilliseconds: (retryContext) => {
          if (retryContext.elapsedMilliseconds < 6e4) {
      ...
      try {
        ...
        setTimeout(() => this.startConnection(hubName, hubUrl), 5e3);
      }
      return connection;
    });
  }
  ...
  stopAllConnections() {
    return __async(this, null, function* () {
      for (const [name] of this.connections) {
        yield this.stopConnection(name);
      }
    });
  }
  ...
  on(hubName, methodName, callback) {
    const connection = this.connections.get(hubName);
    if (connection) {
  ...
  static {
    this.\u0275fac = function SignalRService_Factory(t) {
      return new (t || _SignalRService)(\u0275\u0275inject(NgZone), \u0275\u0275inject(AuthService));
    };
  }
  static {
...
//# sourceMappingURL=chunk-VXOLMSSB.js.map
