        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(), interest-cohort=()" },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' http://localhost:5026 http://localhost:5000 ws://localhost:5026 ws://localhost:5000 wss://teleprompt-api.invalid https://teleprompt-api.invalid https://vlibras.gov.br",
              "frame-src 'none'",
